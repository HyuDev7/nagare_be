...
class RecurringTransactionUseCase(
    ...
    private val settingsRepository: com.paymentflow.domain.repository.SettingsRepository,
    private val assetAccountRepository: com.paymentflow.domain.repository.AssetAccountRepository
) {
